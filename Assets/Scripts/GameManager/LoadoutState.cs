        ...
        if (!m_IsLoadingCharacter)
        {
            ...
            while (newChar == null)
            {
                ...
                if (c != null)
                {
                    ...
                    pos.x = m_OwnedAccesories.Count > 0 ? k_OwnedAccessoriesCharacterOffset : 0.0f;
                    ...
                    {
                        Debug.LogWarning($"Unable to load character {c.characterName} from Resources.");
                        yield break;
                    }

                    // ✅ Instantiate Character
                    newChar = Instantiate(characterPrefab);
                    ...
                    // ✅ Prevent "T-pose Flash" by Moving Character Off-screen
