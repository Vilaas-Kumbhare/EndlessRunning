...
public abstract class Consumable : MonoBehaviour
{
    ...
    public GameObject RefActivatedParticleReference;
    ...
    public virtual IEnumerator Started(CharacterInputController c)
    {
        ...
        if (RefActivatedParticleReference != null)
        {
            // ✅ Load particle system prefab from Resources
            GameObject particlePrefab = Resources.Load<GameObject>("PowerUpParticle/" + RefActivatedParticleReference.name);

            if (particlePrefab == null)
            {
                Debug.LogWarning($"Unable to load particle effect {RefActivatedParticleReference.name} from Resources.");
                yield break;
            }
